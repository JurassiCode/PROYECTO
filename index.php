        ...
        >
          <div class="carousel-inner text-center">
            ...
            <div class="carousel-item">
              <blockquote class="blockquote">
                <p class="mb-4">
                  "Nos evitó discusiones y errores de cuenta. ¡La interfaz es
                  tan clara que hasta mi abuela lo usa!"
                </p>
                <footer class="blockquote-footer">Tomi</footer>
              </blockquote>
            </div>
            <div class="carousel-item">
              <blockquote class="blockquote">
                <p class="mb-4">
                  "La usabilidad está perfecta. En segundos ya estás jugando, no
                  hay que explicar nada técnico."
                </p>
                <footer class="blockquote-footer">Nacho</footer>
              </blockquote>
            </div>
            <div class="carousel-item">
              <blockquote class="blockquote">
                <p class="mb-4">
                  "Está buenísimo que funcione en el celu. Jugamos en la playa y
                  llevamos el puntaje sin drama."
                </p>
                <footer class="blockquote-footer">Marcelo</footer>
              </blockquote>
            </div>
            <div class="carousel-item">
              <blockquote class="blockquote">
                <p class="mb-4">
                  "Lo usamos en el torneo de la UTU. ¡Re fácil de entender y
                  cero errores!"
                </p>
                <footer class="blockquote-footer">Walter</footer>
              </blockquote>
            </div>
            <div class="carousel-item">
              <blockquote class="blockquote">
                <p class="mb-4">
                  "No suelo dar muchas clases de programación, pero este juego
                  me pareció espectacular. Muy bien pensado, ¡sigan así!"
                </p>
                <footer class="blockquote-footer">Matías Prestes</footer>
              </blockquote>
            </div>
          </div>
          <button
