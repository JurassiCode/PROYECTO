...
<head>
  <meta charset="utf-8">
  <title>Crear cuenta · JurassiDraft</title>
    ...
    <div class="rounded-lg border border-gray-200 bg-white shadow-sm p-6 md:p-5">
      <form method="POST" action="{{ route('register.post') }}" novalidate class="space-y-4 md:space-y-3">
        ...
        <div>
          ...
          <input
            id="nombre" name="nombre" type="text" inputmode="text"
        ...
        <div>
          ...
          <input
            id="usuario" name="usuario" type="text" inputmode="text" autocomplete="username"
        ...
        <div>
          ...
          <div class="relative">
            <input
              id="contrasena" name="contrasena" type="password" autocomplete="new-password"
          ...
          @error('contrasena') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
        </div>

        <!-- Confirmación -->
        <div>
          <label for="contrasena_confirmation" class="mb-1 block text-sm font-medium text-gray-700">Confirmar contraseña</label>
          <div class="relative">
            <input
              id="contrasena_confirmation" name="contrasena_confirmation" type="password" autocomplete="new-password"
          ...
          @error('contrasena_confirmation') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
        </div>
