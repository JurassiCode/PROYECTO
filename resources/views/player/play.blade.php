    ...
    <div class="mx-auto max-w-6xl px-6">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-4xl font-extrabold mb-2 tracking-tight">
                Configurar <span class="text-emerald-300">Partida</span>
            </h1>
            <p class="text-sm text-emerald-200/80">Agregá jugadores, nombrá tu sala y prepará todo para el trackeo.</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-md p-6">
                ...
                <form method="POST" action="{{ route('play.add') }}" class="flex flex-col sm:flex-row gap-3">
                    @csrf
                    <input
                        type="text"
                        name="identificador"
                ...
                <p class="mt-2 text-xs text-gray-400">
                    Se valida contra la tabla <code>usuarios</code> (por <code>id_usuario</code> o <code>usuario</code>). Máximo 6 jugadores.
                </p>
            </div>
            ...
            <div class="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-md p-6">
                ...
                {{-- Vaciar lista --}}
                <form method="POST" action="{{ route('play.clear') }}" class="mb-3">
                    @csrf
                    <button
